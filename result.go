...
// FlatMapErr executes the mapper function if Result is invalid. It returns a new Result.
// Play: https://go.dev/play/p/7V2qbrEungZ
func (r Result[T]) FlatMapErr(mapper func(error) Result[T]) Result[T] {
	if r.isErr {
		return mapper(r.err)
	}
